...
def compute_params_SGDR(diamonds, prices, validation, validation_prices, _it, _lr):
    ...
    regr = linear_model.SGDRegressor(max_iter=_it, eta0=_lr, verbose=1)
    regr.fit(np_X, np_Y)
...
def main():
    ...
    regr = compute_params_SGDR(diamonds_train, diamonds_prices_train,
            diamonds_valid, diamonds_prices_valid, iterations, learning_rate)
